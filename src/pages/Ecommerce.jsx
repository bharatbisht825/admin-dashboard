...
const Ecommerce = () => {
  ...
  return (
    <div className="mt-24 p-4 lg:p-12">
      <div className="flex justify-center flex-col">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center mx-auto w-full md:w-11/12">
        ...
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4 w-full md:w-11/12 mx-auto">
          {earningData.map((item) => (
            <div
              key={item.title}
              className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg w-full p-4 pt-9 rounded-2xl "
            >
              <button
                type="button"
